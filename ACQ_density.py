...
Data generated by density_ACQ.py
"""
...
Fc = 10e6                        # Pulse frequency - Hz
Excitation = 'Pulse'            # Excitation to use ('Pulse, 'Chirp', 'Burst') - string
Excitation_params = Fc          # All excitation params - list or float
Smin1, Smin2 = 3000, 3000       # starting point of the scan of each channel - samples
Smax1, Smax2 = 4500, 4500       # last point of the scan of each channel - samples
