...
########################################################
Path = r'D:\Data'
Experiment_folder_name = 'TestAluminumDriftCorrection' # Without Backslashes
...
Experiment_description = """Test drift correction with aluminum plate.
3D-printed vessel.
Focused tx.
...
Smax1, Smax2 = 9000, 9000       # last point of the scan of each channel - samples
AvgSamplesNumber = 25           # Number of traces to average to improve SNR
Quantiz_Levels = 1024           # Number of quantization levels
Ts_acq = 10                      # Time between acquisitions (if None, script waits for user input). Coding time is about 1.5s (so Ts_acq must be >1.5s) - seconds
N_acqs = 5000                   # Total number of acquisitions
...
Cc = 4459                       # speed of sound in the container - m/s
windowPE = False                # If True, apply windowing to the echo signal specified by Loc_PER, Loc_PETR, WinLen_PER and WinLen_PETR - bool
Loc_TT = 7600-5000                   # position of Through Transmission, approximation - samples
Loc_WP = 8300-5000                  # position of Water Path, approximation - samples
Loc_PER = 6000-5000                  # position of echo from front surface, approximation - samples
Loc_PETR = 12000-5000               # position of echo from back surface, approximation (only used with container) - samples
WinLen_TT = 800                 # window length of Through Transmission, approximation - samples
WinLen_WP = 800           # window length of Water Path, approximation - samples
