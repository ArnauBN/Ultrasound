...
ResinCw = True                  # If True, temperature is measured in the resin and Cw is computed acordingly - bool
...
if Temperature:
    ...
    WP_Cw = US.temp2sos(mean1, material='water', method='Abdessamad', method_param=148)
...
for i in range(N_acqs):
    ...
    # -----------------------------------
    cw = WP_Cw if ResinCw else Cw_vector[0]
    if Charac_container or no_container:
        if no_container:
