...
Experiment_folder_name = 'W0_0' # Without Backslashes
...
Loc_TT = 8200-5000                   # position of Through Transmission, approximation - samples
...
WinLen_PER = 1300          # window length echo from front surface, approximation - samples
WinLen_PETR = 1300         # window length of echo from back surface, approximation (only used with container) - samples
